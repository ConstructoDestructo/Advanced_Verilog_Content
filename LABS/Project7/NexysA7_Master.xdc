...
set_property -dict {PACKAGE_PIN H6 IOSTANDARD LVCMOS33} [get_ports {cs[0]}]
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports {cs[1]}]
set_property -dict {PACKAGE_PIN U11 IOSTANDARD LVCMOS33} [get_ports {timer_run}]
